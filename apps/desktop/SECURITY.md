...
Use [GitHub's private vulnerability reporting](https://github.com/Pyper/pyper/security/advisories/new)
to submit a report. You can also email security@pyper.work.
