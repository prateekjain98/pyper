# Contributing to Pyper

Thanks for your interest in contributing. Pyper is an open-source,
...
**[docs.pyper.work/contributing](https://docs.pyper.work/contributing)**.
...
- Bugs and feature requests:
  [github.com/Pyper/pyper/issues](https://github.com/Pyper/pyper/issues)
...
[GitHub's private vulnerability reporting](https://github.com/Pyper/pyper/security/advisories/new)
or email `security@pyper.work`.

## Contributing code

See the [contributing guide](https://docs.pyper.work/contributing)
...
4. Open a pull request against `Pyper/pyper` `main` and fill
...
improvement helps make Pyper better.
