...
let
  ...
  src = fetchurl {
    url = "https://github.com/Pyper/pyper/releases/download/v${version}/Pyper-${version}-linux-x86_64.AppImage";
...
appimageTools.wrapType2 {
  ...
  extraInstallCommands = ''
    install -Dm444 ${appimageContents}/pyper.desktop \
  ...
  meta = {
    ...
    homepage = "https://pyper.work/";
    changelog = "https://github.com/Pyper/pyper/releases/tag/v${version}";
