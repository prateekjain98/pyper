...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.PYPER_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.PYPER_TRANSCRIPTION_BASE_URL as string | undefined,
...
// Pyper Cloud API
export const PYPER_API_URL = (env.VITE_PYPER_API_URL as string) || "";
