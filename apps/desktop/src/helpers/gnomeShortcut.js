...
const DBUS_SERVICE_NAME = "com.saaslabs.pyper.App";
const DBUS_OBJECT_PATH = "/com/pyper/App";
const DBUS_INTERFACE = "com.saaslabs.pyper.App";

// Per-slot gsettings paths and display names
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/pyper/",
    name: "Pyper Toggle",
  },
  agent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/pyper-agent/",
    name: "Pyper Agent",
  },
  meeting: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/pyper-meeting/",
    name: "Pyper Meeting",
  },
  voiceAgent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/pyper-voice-agent/",
    name: "Pyper Voice Agent",
  },
  translation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/pyper-translation/",
    name: "Pyper Translation",
  },
};
