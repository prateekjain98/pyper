...
const CORTI_SIGNUP_URL =
  "https://www.corti.ai/?utm_source=referral&utm_content=&utm_campaign=pyper";
...
export default function FinishStep({
  ...
  const startWithCorti = () => {
    ...
    // Pyper Cloud handles language features so PHI never reaches a third party.
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {/* Corti Models (LLM) is EU-only; US projects use Pyper Cloud for
