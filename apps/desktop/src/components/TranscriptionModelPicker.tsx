...
> = {
  ...
  corti: {
    consoleUrl: "https://www.corti.ai/?utm_source=referral&utm_content=&utm_campaign=pyper",
    fields: [
  ...
  tinfoil: {
    consoleUrl: "https://tinfoil.sh/inference?utm_source=referral&utm_campaign=pyper",
...
export default function TranscriptionModelPicker({
  ...
  useEffect(() => {
    ...
    window.addEventListener("pyper-models-cleared", handleModelsCleared);
    return () => window.removeEventListener("pyper-models-cleared", handleModelsCleared);
