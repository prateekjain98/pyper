...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.saaslabs.pyper.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "pyper-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Pyper Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.saaslabs.pyper.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "PyperAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
