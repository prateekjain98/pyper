...
<p align="center">
  <a href="https://github.com/Pyper/pyper/blob/main/LICENSE"><img src="https://img.shields.io/github/license/Pyper/pyper?style=flat" alt="License" /></a>
  <img src="https://img.shields.io/badge/platform-macOS%20%7C%20Windows%20%7C%20Linux-lightgrey?style=flat" alt="Platform" />
  <a href="https://github.com/Pyper/pyper/releases/latest"><img src="https://img.shields.io/github/v/release/Pyper/pyper?style=flat&sort=semver" alt="GitHub release" /></a>
  <a href="https://github.com/Pyper/pyper/releases"><img src="https://img.shields.io/github/downloads/Pyper/pyper/total?style=flat&color=blue" alt="Downloads" /></a>
  <a href="https://github.com/Pyper/pyper/stargazers"><img src="https://img.shields.io/github/stars/Pyper/pyper?style=flat" alt="GitHub stars" /></a>
</p>
...
<p align="center">
  <a href="https://pyper.work">Website</a> &middot;
  <a href="https://docs.pyper.work">Docs</a> &middot;
  <a href="https://github.com/Pyper/pyper/releases/latest">Download</a> &middot;
  <a href="https://docs.pyper.work/api/overview">API</a> &middot;
  <a href="https://github.com/Pyper/pyper/blob/main/CHANGELOG.md">Changelog</a>
</p>

---

Pyper turns your voice into text, notes, and actions from your desktop. Press a hotkey, speak, and your words appear at your cursor. Choose between fully private offline transcription with local speech-to-text engines like Whisper and NVIDIA Parakeet — where your audio never leaves your device — or cloud processing for speed. No data collection, no telemetry, fully open source.

## Download

| Platform              | Download                                                                                                                                                                                                                                                                                  |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| macOS (Apple Silicon) | [`.dmg`](https://github.com/Pyper/pyper/releases/latest)                                                                                                                                                                                                                        |
| macOS (Intel) \*      | [`.dmg`](https://github.com/Pyper/pyper/releases/latest)                                                                                                                                                                                                                        |
| Windows               | [`.exe`](https://github.com/Pyper/pyper/releases/latest)                                                                                                                                                                                                                        |
| Linux                 | [`.AppImage`](https://github.com/Pyper/pyper/releases/latest) / [`.deb`](https://github.com/Pyper/pyper/releases/latest) / [`.rpm`](https://github.com/Pyper/pyper/releases/latest) / [`.tar.gz`](https://github.com/Pyper/pyper/releases/latest) |
...
- **Public API & MCP** — manage notes and transcriptions programmatically or connect your AI assistant via the [MCP server](https://docs.pyper.work/integrations/mcp)

## Quick start

```bash
git clone https://github.com/Pyper/pyper.git
cd pyper
npm install
npm run dev
```

Requires Node.js 24+. See the [full documentation](https://docs.pyper.work/quickstart) for setup guides, platform-specific instructions, and build details.

## Documentation

Visit **[docs.pyper.work](https://docs.pyper.work)** for:

- [Getting started](https://docs.pyper.work/quickstart)
- [Platform guides](https://docs.pyper.work/platform/macos) (macOS, Windows, Linux)
- [API reference](https://docs.pyper.work/api/overview)
- [MCP server setup](https://docs.pyper.work/integrations/mcp)
- [Troubleshooting](https://docs.pyper.work/troubleshooting)
...
[![Star History Chart](https://api.star-history.com/svg?repos=Pyper/pyper&type=date&legend=top-left)](https://www.star-history.com/#Pyper/pyper&type=date&legend=top-left)

## Sponsors

<p align="center">
  <a href="https://console.neon.tech/app/?promo=pyper">
    <picture>
...
<p align="center"><a href="https://console.neon.tech/app/?promo=pyper">Neon</a> is the serverless Postgres platform powering Pyper Cloud.</p>

## Contributing

We welcome contributions. Fork the repo, create a feature branch, and open a pull request. See the [contributing guide](https://docs.pyper.work/contributing) for development setup and guidelines.
...
- **[Neon](https://console.neon.tech/app/?promo=pyper)** — serverless Postgres powering Pyper Cloud
