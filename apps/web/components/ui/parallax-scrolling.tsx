...
interface ParallaxComponentProps {
  ...
  title?: string;
  /** Optional hero content (tagline + CTAs) overlaid on the lower scene. */
  children?: React.ReactNode;
}

export function ParallaxComponent({ title = 'Pyper', children }: ParallaxComponentProps) {
    ...
    <div className="parallax" ref={parallaxRef}>
      <section className="parallax__header">
        <div className="parallax__visuals">
          ...
          {children ? <div className="parallax__overlay">{children}</div> : null}
